    ...
    <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="w-100" src="dairy-website-template/img/bg.jpeg" alt="Image">
          <div class="carousel-caption">
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-lg-8 text-start">
                  <p class="fs-4 text-white">Welcome to our bookstore</p>
                  <h1 class="display-1 text-white mb-5 animated slideInRight">A Haven for Book Lovers</h1>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row g-5 align-items-end">
        <div class="col-lg-6">
          <div class="row g-2">
            ...
            <div class="col-6 wow fadeIn" data-wow-delay="0.1s">
              <img class="img-fluid rounded" src="dairy-website-template/img/about-1.jpeg">
            </div>
            <div class="col-6 wow fadeIn" data-wow-delay="0.3s">
              <img class="img-fluid rounded" src="dairy-website-template/img/about-2.jpeg">
            </div>
            <div class="col-6 wow fadeIn" data-wow-delay="0.5s">
              <img class="img-fluid rounded" src="dairy-website-template/img/about-3.jpeg">
            </div>
          </div>
        </div>
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
          ...
          <div class="row g-5 pt-2 mb-5">
            <div class="col-sm-6">
              <img class="img-fluid mb-4" src="dairy-website-template/img/operator.png" alt="">
            ...
            <div class="col-sm-6">
              <img class="img-fluid mb-4" src="dairy-website-template/img/book.png" alt="">
