                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="proses_deletesupplier.php ?id=<?php echo $data['id_supplier']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('delete?');">Delete</a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                <?php  } ?>
