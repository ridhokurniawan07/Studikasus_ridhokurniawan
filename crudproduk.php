            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="editproduk.php?id=<?php echo $data['id_produk']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="proses_deleteproduk.php?id=<?php echo $data['id_produk']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete?');">Delete</a>
                        </td>
                    </tr>
                    <?php $no++; ?>
                <?php  } ?>
